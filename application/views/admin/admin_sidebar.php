...
<ul class="wp-block-categoris-cloud">
   <li class="dropdown dwmain"><a href="javascript:void(0)" class="<?php if(($this->uri->segment(2)=="user") || ($this->uri->segment(2)=="dealer") || ($this->uri->segment(1)=="profile")){echo "active2"; }?>"><span><i class="fa fa-user"></i> User Management <i class="fa fa fa-caret-down"></i></span></a>
	...
	<li class="dropdown dwmain"><a href="javascript:void(0)" class="<?php if(($this->uri->segment(2)=="car") || ($this->uri->segment(2)=="market_price")){echo "active2"; }?>"><span><i class="fa fa-automobile"></i> Car Management <i class="fa fa fa-caret-down"></i></span></a>
      <ul class="subdropdown" <?php if(($this->uri->segment(2)=="car") || ($this->uri->segment(2)=="market_price")){?> style="display:block;" <?php }?>>
...
<li><a <?php if(@$active=='aboutedit'){ echo"active"; } ?>  href="<?= base_url('admin/about/edit') ?>"><span> About Us</span></a></li>
	...
	<li class="dropdown dwmain"><a href="javascript:void(0)" class="<?php if(($this->uri->segment(2)=="blogs") || ($this->uri->segment(2)=="blog")){echo "active2"; }?>"><span><i class="fa fa-rss"></i> Blog Management <i class="fa fa fa-caret-down"></i></span></a>
      <ul class="subdropdown" <?php if(($this->uri->segment(2)=="blogs" ) || ($this->uri->segment(2)=="blog")){?> style="display:block;" <?php }?>>
...
<li><a href="<?= base_url('car-list') ?>"><span><i class="fa fa-automobile"></i> Cars List</span></a></li>
<li><a href="<?= base_url('admin/header_footer/edit') ?>"><span><i class="fa fa-check"></i> Header & Footer</span></a></li>
<li><a href="<?= base_url('admin/home/edit') ?>"><span><i class="fa fa-check"></i> Home page</span></a></li>
<li><a <?php if(@$active=='aboutedit'){ echo"active"; } ?>  href="<?= base_url('admin/about/edit') ?>"><span><i class="fa fa-check"></i> About Us page</span></a></li>


<li><a href="<?= base_url('admin/faq/edit') ?>"><span><i class="fa fa-check"></i> FAQ page</span></a></li>
<li><a href="<?= base_url('admin/privacy_policy/edit') ?>"><span><i class="fa fa-check"></i> Privacy Policy page</span></a></li>
<li><a href="<?= base_url('admin/terms_and_conditions/edit') ?>"><span><i class="fa fa-check"></i> Terms and conditions page</span></a></li>


<li><a href="<?= base_url('admin/car/categories') ?>"><span><i class="fa fa-check"></i> Car category</span></a></li>
<li><a href="<?= base_url('admin/blog/categories') ?>"><span><i class="fa fa-check"></i> Blog category</span></a></li>
<li><a href="<?= base_url('admin/blogs') ?>"><span><i class="fa fa-check"></i> Blog page</span></a></li>
<li><a href="<?= base_url('admin/contact/edit') ?>"><span><i class="fa fa-check"></i> Contact Us page</span></a></li>
