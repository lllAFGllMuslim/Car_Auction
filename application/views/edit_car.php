...
<select name="service_history" id="service_history">
    ...
    <option value="yes" <?php if(!empty($car['service_history']) && $car['service_history'] == 'yes') echo 'selected'; ?>>Yes</option>
    <option value="no" <?php if(!empty($car['service_history']) && $car['service_history'] == 'no') echo 'selected'; ?>>No</option>
</select>
</div>
<div class="col-lg-3 add_sty1">
