...
if(!empty($users)){
  ...
  ?>
  <tr class="sert54">
  <td class="head15700 stuj8"><?php echo ucwords(strtolower($user->firstname.' '.$user->lastname)); ?> </td>
    ...
    <td class="head15700 stuj8 text-center"><?php if(!empty($user->DT_sold)){ echo $user->DT_sold; }else{ echo"-"; } ?></a></td>
  </tr>
