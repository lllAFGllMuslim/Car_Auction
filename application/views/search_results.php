...
<?php /*?>window.onload = function(){
            var hideMe = document.getElementById('sdr');
			var slider1 = document.getElementById('slider1');
			
			var hideMe2 = document.getElementById('sdr2');
			var slider2 = document.getElementById('slider2');
			
			var hideMe3 = document.getElementById('sdr1');
			var slider3 = document.getElementById('year-slider1');
...
<select name="mileage" id="mileage" >
    ...
    for ($i = 0; $i <= 40000; $i += 10) {
        $start = $i;
        $end = $i + 10;
           $selected1 = (isset($_GET['mileage']) && $_GET['mileage'] === "{$start} - {$end}") ? 'selected' : '';
            echo "<option value='{$start} - {$end}' {$selected1}>{$start} - {$end}</option>";
...
<?php /*?><div class="col filter-demo">
   <ul class="filters">
      <li><a>Select Years</a>
         <ul class="dropdown dropdown--price">
            <li>
               <div class="slider-container" data-role="rangeslider">
                  <div class="slider2 slider--min">
                     <label for="min-mileage"><?php if(isset($_REQUEST['min-mileage'])) { echo $_REQUEST['min-mileage']; } else {?>10<?php  } ?></label>
                     <input type="range" name="min-mileage" id="min-mileage" value="<?php if(isset($_REQUEST['min-mileage'])) { echo $_REQUEST['min-mileage']; } else {?>10<?php  } ?>" min="10" max="999">
                  </div>
                  <div class="slider2 slider--max">
                     <label for="max-mileage"><?php if(isset($_REQUEST['max-mileage'])) { echo $_REQUEST['max-mileage']; } else {?>999<?php  } ?></label>
                     <input type="range" name="max-mileage" id="max-mileage" value="<?php if(isset($_REQUEST['max-mileage'])) { echo $_REQUEST['max-mileage']; } else {?>999<?php  } ?>" min="10" max="999">
...
<div class="col polk55">
    ...
    <!-- Hidden inputs to store min and max year values -->
...
<option <?php if($this->input->get('cat_year')==$value3->year_slug){ echo"selected"; } ?> value="<?php echo $value3->year_slug; ?>"><?php echo $value3->year_name; ?></option>
<?php
 }
}
?>
      ...
      <li><a>Select Years</a>
         <ul class="dropdown dropdown--price">
            <li>
               <div class="slider-container" data-role="rangeslider">
                  <div class="slider2 slider--min">
                     <label for="min-year"><?php if(isset($_REQUEST['min-year'])) { echo $_REQUEST['min-year']; } else {?>2000<?php  } ?></label>
                     <input type="range" name="min-year" id="min-year" value="<?php if(isset($_REQUEST['min-year'])) { echo $_REQUEST['min-year']; } else {?>2000<?php  } ?>" value="2000"  min="2000" max="2024">
                  </div>
                  <div class="slider2 slider--max">
                     <label for="max-year"><?php if(isset($_REQUEST['max-year'])) { echo $_REQUEST['max-year']; } else {?>2024<?php  } ?></label>
                     <input type="range" name="max-year" id="max-year" value="<?php if(isset($_REQUEST['max-year'])) { echo $_REQUEST['max-year']; } else {?>2024<?php  } ?>" min="2000" max="2024">
                     <div class="slider-progress"></div>
                  </div>
               </div>
            </li>
...
<select name="price" id="price" >
    ...
    for ($i = 0; $i <= 500000; $i += 500) {
        $start = $i;
        $end = $i + 500;
       $selected = (isset($_GET['price']) && $_GET['price'] === "{$start} - {$end}") ? 'selected' : '';
            echo "<option value='{$start} - {$end}' {$selected}>{$start} - {$end}</option>";
...
<?php /*?><div class="col filter-demo">
   <ul class="filters">
      <li><a>Select Price Range (<?php echo $this->config->item('CURRENCY'); ?>)</a>
         <ul class="dropdown dropdown--price">
            <li>
               <div class="slider-container" data-role="rangeslider">
                  <div class="slider slider--min">
                     <label for="min-price"><?php if(isset($_REQUEST['min-price'])) { echo $_REQUEST['min-price']; } else {?>10000<?php  } ?></label>
                     <input type="range" name="min-price" id="min-price" value="<?php if(isset($_REQUEST['min-price'])) { echo $_REQUEST['min-price']; } else {?>10000<?php  } ?>"  min="10000" max="999999">
                  </div>
                  <div class="slider slider--max">
                     <label for="max-price"><?php if(isset($_REQUEST['max-price'])) { echo $_REQUEST['max-price']; } else {?>999999<?php  } ?></label>
                     <input type="range" name="max-price" id="max-price" value="<?php if(isset($_REQUEST['max-price'])) { echo $_REQUEST['max-price']; } else {?>999999<?php  } ?>" min="10000" max="999999">
                     <div class="slider-progress"></div>
                  </div>
               </div>
            </li>
