...
// print_r($cars);
   ...
   if(!empty($bid_by_user)){
       ...
       print_r($profile_data["first_name"].' '.$profile_data["last_name"]);
...
<div class="col-lg-4 col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="200ms">
...
<a href="javascript:;" data-id="<?php echo $car["id"]; ?>" data-user_id="<?php echo $user_id; ?>"  class="fav add-fav"><i class="fa <?php echo $class; ?>"></i></a>
<?php 
