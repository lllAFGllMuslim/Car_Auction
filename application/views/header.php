...
<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/mibreitGallery.css"/> 
<style>
...
<a href="<?php echo base_url(); ?>"><img src="<?php if(!empty($header_data['logo_id'])){echo get_image_path_by_id($header_data['logo_id']);  } ?>" style="max-width:250px;" alt></a>


</div>
<div class="search-area">
<?php /*?><?php if(!$this->session->userdata('user_id')){ }else{ ?><?php */?>

  <form name="search" id="search" action="<?= base_url('search') ?>" method="get" >
<div class="form-inner">
<input name="title" id="title" require type="text" placeholder="Sök Bil" value="<?php if(!empty($this->input->get('title'))){ echo $this->input->get('title'); } ?>">
...
<li>
<button type="button" class="primary-btn1" data-bs-toggle="modal" data-bs-target="#logInModal01">
...
<div class="user_web5"><a href="<?php echo $url; ?>" class="mob_user155" style="background-image:url(<?php if(!empty($profile_data['profle_photo_id'])){echo get_image_path_by_id($profile_data['profle_photo_id']);  }else{ ?><?= base_url(); ?>assets/img/us3.jpg<?php } ?>);"></a>
<a href="<?php echo $url; ?>" class="style1235">
...
<a href="<?php echo base_url(); ?>"><img alt="" class="img-fluid" src="<?php if(!empty($header_data['logo_id'])){echo get_image_path_by_id($header_data['logo_id']);  } ?>"></a>
</div>
<div class="main-menu">
<div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
<div class="mobile-logo-wrap">
<a href="<?php echo base_url(); ?>"><img alt="image" src="<?php if(!empty($header_data['logo_id'])){echo get_image_path_by_id($header_data['logo_id']);  } ?>"></a></div>
</div>
<ul class="menu-list">
...
<a class="primary-btn3" href="javascript:;" data-bs-toggle="modal" data-bs-target="#logInModal01">
<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M14.4311 12.759C15.417 11.4291 16 9.78265 16 8C16 3.58169 12.4182 0 8 0C3.58169 0 0 3.58169 0 8C0 12.4182 3.58169 16 8 16C10.3181 16 12.4058 15.0141 13.867 13.4387C14.0673 13.2226 14.2556 12.9957 14.4311 12.759ZM13.9875 12C14.7533 10.8559 15.1999 9.48009 15.1999 8C15.1999 4.02355 11.9764 0.799983 7.99991 0.799983C4.02355 0.799983 0.799983 4.02355 0.799983 8C0.799983 9.48017 1.24658 10.8559 2.01245 12C2.97866 10.5566 4.45301 9.48194 6.17961 9.03214C5.34594 8.45444 4.79998 7.49102 4.79998 6.39995C4.79998 4.63266 6.23271 3.19993 8 3.19993C9.76729 3.19993 11.2 4.63266 11.2 6.39995C11.2 7.49093 10.654 8.45444 9.82039 9.03206C11.5469 9.48194 13.0213 10.5565 13.9875 12ZM13.4722 12.6793C12.3495 10.8331 10.3188 9.59997 8.00008 9.59997C5.68126 9.59997 3.65049 10.8331 2.52776 12.6794C3.84829 14.2222 5.80992 15.2 8 15.2C10.1901 15.2 12.1517 14.2222 13.4722 12.6793ZM8 8.79998C9.32551 8.79998 10.4 7.72554 10.4 6.39995C10.4 5.07444 9.32559 3.99992 8 3.99992C6.6744 3.99992 5.59997 5.07452 5.59997 6.40003C5.59997 7.72554 6.67449 8.79998 8 8.79998Z"></path>
</svg>
LOGIN</a>
<?php } else { ?>
<a class="primary-btn3" href="<?= base_url('profile') ?>">
<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M14.4311 12.759C15.417 11.4291 16 9.78265 16 8C16 3.58169 12.4182 0 8 0C3.58169 0 0 3.58169 0 8C0 12.4182 3.58169 16 8 16C10.3181 16 12.4058 15.0141 13.867 13.4387C14.0673 13.2226 14.2556 12.9957 14.4311 12.759ZM13.9875 12C14.7533 10.8559 15.1999 9.48009 15.1999 8C15.1999 4.02355 11.9764 0.799983 7.99991 0.799983C4.02355 0.799983 0.799983 4.02355 0.799983 8C0.799983 9.48017 1.24658 10.8559 2.01245 12C2.97866 10.5566 4.45301 9.48194 6.17961 9.03214C5.34594 8.45444 4.79998 7.49102 4.79998 6.39995C4.79998 4.63266 6.23271 3.19993 8 3.19993C9.76729 3.19993 11.2 4.63266 11.2 6.39995C11.2 7.49093 10.654 8.45444 9.82039 9.03206C11.5469 9.48194 13.0213 10.5565 13.9875 12ZM13.4722 12.6793C12.3495 10.8331 10.3188 9.59997 8.00008 9.59997C5.68126 9.59997 3.65049 10.8331 2.52776 12.6794C3.84829 14.2222 5.80992 15.2 8 15.2C10.1901 15.2 12.1517 14.2222 13.4722 12.6793ZM8 8.79998C9.32551 8.79998 10.4 7.72554 10.4 6.39995C10.4 5.07444 9.32559 3.99992 8 3.99992C6.6744 3.99992 5.59997 5.07452 5.59997 6.40003C5.59997 7.72554 6.67449 8.79998 8 8.79998Z"></path>
</svg>
PROFIL</a>

<a class="primary-btn3" href="<?= base_url('logout') ?>">
<svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
<path d="M11 0C11.2652 0 11.5196 0.105357 11.7071 0.292893C11.8946 0.48043 12 0.734784 12 1V15C12 15.2652 11.8946 15.5196 11.7071 15.7071C11.5196 15.8946 11.2652 16 11 16H1C0.734784 16 0.48043 15.8946 0.292893 15.7071C0.105357 15.5196 0 15.2652 0 15V1C0 0.734784 0.105357 0.48043 0.292893 0.292893C0.48043 0.105357 0.734784 0 1 0H11ZM10 2H2V14H10V2ZM13.82 7L11.41 4.59L12.83 3.17L17.66 8L12.83 12.83L11.41 11.41L13.82 9H6V7H13.82Z"/>
</svg>
UTLOGGNING</a>
<?php } ?>
</div>
...
<div class="content"><?php if(!empty($header_data['manu_name7'])){?>
<span>För Mer Information</span>
<h6><a href="tel:+<?php echo $header_data['manu_name7']; ?>"><?php echo $header_data['manu_name7']; ?></a></h6> <?php } ?>
</div>
</div>
</div>
...
<div class="icon">
<img src="<?php echo base_url(); ?>/assets/img/home1/icon/hotline-icon.svg" alt>
</div>
<div class="content">
<?php if(!empty($header_data['manu_name7'])){?>
<span>För Mer Information</span>
<h6><a href="tel:<?php echo $header_data['manu_name7']; ?>"><?php echo $header_data['manu_name7']; ?></a></h6> <?php } ?>
</div>
</div>
