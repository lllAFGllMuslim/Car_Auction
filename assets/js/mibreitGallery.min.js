var mibreitGallery = function(t) {
    ...
    class C {
        ...
        _setScaleModeForThumbs() {
            const t = this._thumbContainers.innerWidth(),
                e = this._thumbContainers.innerHeight();
    ...
    class f {
        ...
        _resizeNeeded() {
            const t = o()(this._thumbviewContainer).width() - 7 * parseFloat(o()(":root").css("font-size"));
            this._newVisibleWidth !== t && (this._newVisibleWidth = t, o()(_).css({
                width: this._newVisibleWidth + "px"
            }), this._stepSize = this._newVisibleWidth / 7, this._nrVisibleImages = Math.floor(this._newVisibleWidth / this._stepSize), this._nrOfImages <= this._nrVisibleImages ? (this._allowMovement = !1, this._scroller.css({
    ...
    var S = '<svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1363 877l-742 742q-19 19-45 19t-45-19l-166-166q-19-19-19-45t19-45l531-531-531-531q-19-19-19-45t19-45l166-166q19-19 45-19t45 19l742 742q19 19 19 45t-19 45z"/></svg>',
        E = '<svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M1152 896q0 26-19 45l-448 448q-19 19-45 19t-45-19-19-45v-896q0-26 19-45t45-19 45 19l448 448q19 19 19 45z"/></svg>';
